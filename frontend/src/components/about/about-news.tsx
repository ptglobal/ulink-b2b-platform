  ...
  return (
    <section className="py-8 lg:py-12">
      ...
      <div className="mt-8 flex justify-center">
        <Link
          href="/about/news"
          className="inline-flex items-center justify-center rounded-lg border border-slate-200 bg-white px-6 py-2.5 text-sm font-semibold text-slate-700 shadow-sm hover:bg-slate-50 hover:text-blue-600 transition-all"
        >
          Xem tất cả
        </Link>
      </div>
