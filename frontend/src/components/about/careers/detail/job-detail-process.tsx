    ...
    <section className="py-6 border-t border-slate-100" id="apply">
      ...
      <div className="mt-6 rounded-xl bg-blue-50 p-5 border border-blue-100 flex flex-col sm:flex-row items-center justify-between gap-4">
        ...
        <a
          ...
          className="inline-flex shrink-0 items-center justify-center rounded-lg bg-blue-600 px-5 py-2.5 text-xs font-semibold text-white shadow-sm hover:bg-blue-700 transition-[color,background-color,border-color,box-shadow,opacity,transform]"
        >
          Gửi CV qua Email
        </a>
      </div>
