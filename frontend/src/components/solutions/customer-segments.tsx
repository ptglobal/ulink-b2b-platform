            ...
            <div>
              ...
              <ul className="space-y-4 mb-10">
                {bullets.map((bullet, idx) => (
                  <li key={idx} className="flex items-start gap-3 text-xs sm:text-sm font-medium leading-relaxed">
          ...
          <div className="w-full max-w-[640px] flex flex-col justify-between">
            <div>
              ...
              <div className="flex items-center gap-4 mb-8">
                ...
                <h3 className="text-lg sm:text-xl font-bold text-[#0F1E36] tracking-tight">
              ...
              <ul className="space-y-4 mb-10">
                {bullets.map((bullet, idx) => (
                  <li key={idx} className="flex items-start gap-3 text-xs sm:text-sm text-slate-650 font-medium leading-relaxed">
