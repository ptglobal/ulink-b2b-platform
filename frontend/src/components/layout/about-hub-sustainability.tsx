...
import { Leaf, Zap, Recycle, Boxes, ArrowRight } from '@/components/icons';
...
export async function AboutHubSustainability() {
  ...
  return (
    <section className="flex flex-col gap-6 rounded-[0.25rem] border border-border bg-background px-6 py-6 lg:flex-row lg:items-center lg:justify-between lg:px-8">
      ...
      <Link
        ...
        className="group inline-flex h-[42px] shrink-0 items-center justify-center gap-2 rounded-[0.25rem] border border-brand-strong bg-brand px-6 text-[13px] font-semibold text-white transition-colors hover:bg-brand-strong"
      >
        {tCta('button')}
