    ...
    <aside className="w-full shrink-0 border-r border-border lg:w-[228px]">
      <nav className="flex flex-col py-6 pr-3">
            ...
            return (
              <li key={item.key}>
                <Link
                  ...
                  className={`relative block overflow-hidden rounded-[0.25rem] px-4 py-2.5 text-[11px] font-bold transition-[color,background-color,border-color,box-shadow,opacity,transform] duration-200 ${
                    active
        ...
        <Link
          ...
          className={`relative flex items-center gap-2 overflow-hidden rounded-[0.25rem] px-4 py-2.5 text-[11px] font-bold transition-[color,background-color,border-color,box-shadow,opacity,transform] duration-200 ${
