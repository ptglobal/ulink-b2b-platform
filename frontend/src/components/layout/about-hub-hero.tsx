...
export async function AboutHubHero() {
  ...
  return (
    <section className="relative overflow-hidden rounded-[0.25rem] border border-border bg-background">
      <div className="flex flex-col lg:flex-row">
        {/* Left: text */}
        <div className="relative z-10 flex flex-col justify-center px-6 py-8 sm:px-8 lg:w-[46%] lg:py-10">
          <p className="text-[11px] font-bold tracking-wide text-foreground">{t('eyebrow')}</p>
