...
export const COLLECTION_DEFS = [
    ...
    fields: [
      ...
      },
      {
        ...
        meta: {
          interface: "input",
          width: "half",
          note: "Brand name (e.g. 3M, Honeywell, Ansell)",
        },
      },
      {
        field: "category",
      ...
      {
        field: "assigned_attributes",
        type: "alias",
        meta: {
          interface: "list-m2m",
          special: ["m2m"],
          options: { template: "{{product_attributes_id.name}}" },
        },
      },
      { field: "meta_title", type: "string", meta: { interface: "input" } },
      {
    ...
    fields: [
      ...
      { field: "attributes", type: "json", meta: { interface: "json" } },
      {
        ...
        meta: {
          ...
          note: 'JSON array of directus_files UUIDs, e.g. ["uuid1","uuid2"]',
        },
      },
    ],
  },
  {
    ...
    meta: {
      icon: "tune",
      note: "Global attribute definitions (master data)",
      sort_field: "sort",
    },
    schema: {},
    fields: [
      ID_FIELD,
      {
        ...
        meta: {
          ...
          required: true,
          width: "half",
          note: "Attribute name (e.g. Size, Color)",
        },
      },
      {
        field: "slug",
        ...
        meta: {
          ...
          required: true,
          width: "half",
          note: "Slug key for SKU JSON (e.g. size, color)",
        },
        schema: { is_unique: true },
      },
      {
      ...
      },
      {
        ...
        meta: {
          interface: "list-o2m",
          special: ["o2m"],
          options: { template: "{{value}} ({{sku_suffix}})" },
        },
      },
    ],
  },
    ...
    fields: [
      ...
      },
      {
        ...
        meta: {
          ...
          required: true,
          width: "half",
          note: "Display value (e.g. Red, Large)",
        },
      },
      {
        field: "sku_suffix",
        ...
        meta: {
          ...
          required: true,
          width: "half",
          note: "Code suffix for SKU (e.g. red, l)",
        },
      },
      {
        field: "sort",
  ...
  },
  {
    ...
    fields: [
      ...
      },
      {
        field: "coordinates",
        type: "string",
        meta: { interface: "input", options: { placeholder: "lat,lng" } },
      },
      // ── Warehouse Capacity ──
      {
        field: "divider_warehouse",
        type: "alias",
        meta: {
          interface: "presentation-divider",
          options: { title: "Warehouse Capacity" },
          special: ["alias", "no-data"],
        },
      },
      {
        field: "warehouse_total_area",
        type: "float",
        meta: {
          interface: "input",
          width: "half",
          options: { placeholder: "m²" },
        },
      },
      {
        field: "warehouse_utilized_area",
        type: "float",
        meta: {
          interface: "input",
          width: "half",
      ...
      {
        field: "warehouse_available_area",
        type: "float",
        meta: {
          interface: "input",
          width: "half",
      ...
      {
        field: "warehouse_storage_tons",
        type: "integer",
        meta: {
          interface: "input",
          width: "half",
          options: { placeholder: "tons" },
        },
      },
      {
        field: "warehouse_pallets",
        type: "integer",
        meta: {
          interface: "input",
          width: "half",
          options: { placeholder: "pallets" },
        },
      },
      // ── SLA Metrics ──
      {
        ...
        meta: {
          interface: "presentation-divider",
          options: { title: "SLA Metrics" },
          special: ["alias", "no-data"],
        },
      },
      {
        field: "standard_delivery_time",
        type: "string",
      ...
      {
        field: "on_time_rate_delta",
        type: "string",
        meta: {
          interface: "input",
          width: "half",
          options: { placeholder: "e.g. +2.1%" },
        },
      },
      {
        field: "orders_today",
      ...
      {
        field: "avg_delivery_distance",
        type: "float",
        meta: {
          interface: "input",
          width: "half",
          options: { placeholder: "km" },
        },
      },
      // ── Technical Team ──
      {
        ...
        meta: {
          interface: "presentation-divider",
          options: { title: "Technical Team" },
          special: ["alias", "no-data"],
        },
      },
      {
        field: "person_in_charge_name",
        type: "string",
        meta: { interface: "input", width: "half" },
      },
      {
        field: "person_in_charge_title",
        type: "string",
        meta: { interface: "input", width: "half" },
      },
      {
        field: "person_in_charge_phone",
        type: "string",
        meta: { interface: "input", width: "half" },
      },
      {
        field: "current_personnel_count",
        type: "integer",
        meta: { interface: "input", width: "half" },
      },
      // ── O2M Relations ──
      {
        field: "industrial_zones",
        type: "alias",
        meta: { interface: "list-o2m", special: ["o2m"] },
      },
      {
    ...
    fields: [
      ...
      },
      {
        ...
        meta: {
          interface: "file-image",
          special: ["file"],
          note: "Certificate cover image displayed in the public resource catalogue and detail page.",
          options: {
            sources: ["library"],
          },
        },
    ...
    fields: [
      ...
      { field: "body", type: "text", meta: { interface: "wysiwyg" } },
      {
        ...
        meta: {
          interface: "input-code",
          options: { language: "json" },
          note: "Structured Carbon page modules. Business content only; UI labels stay in next-intl.",
        },
      },
      { field: "meta_title", type: "string", meta: { interface: "input" } },
      {
    ...
    fields: [
      ...
      { field: "hero_section", type: "json", meta: { interface: "json" } },
      {
        ...
        meta: {
          interface: "input-code",
          options: { language: "json" },
          note: "Localized Carbon homepage modules and unique media assignments.",
        },
      },
    ],
  },
  {
    ...
    fields: [
      ...
      {
        field: "hard_deleted_at",
        type: "timestamp",
        meta: { interface: "datetime" },
      },
      {
        field: "hard_deleted_by",
        type: "uuid",
        meta: { interface: "select-dropdown-m2o", special: ["m2o"] },
      },
  ...
  },
  {
    ...
    fields: [
      ...
      },
      {
        ...
        type: "decimal",
        meta: { interface: "input" },
        schema: { numeric_precision: 15, numeric_scale: 2 },
      },
      {
        field: "tax",
        type: "decimal",
  ...
  },
  {
    ...
    fields: [
      ...
      },
      {
        field: "payload",
        type: "json",
        meta: { interface: "json", required: true },
      },
      {
        field: "status",
        type: "string",
  ...
  },
  {
    ...
    fields: [
      ...
      },
      {
        field: "line_items",
        type: "json",
        meta: { interface: "json", hidden: true },
      },
        ...
        meta: {
          ...
          options: {
            choices: [
              ...
              {
                text: "Trục 2: Hành Lang Đông Bắc & Cảng Biển",
                value: "Trục 2",
              },
  ...
  },
  {
    ...
    meta: {
      icon: "verified",
      note: "Product Standards & Certifications (e.g. ISO 14644, EN 455)",
    },
    schema: {},
    fields: [
      ID_FIELD,
  ...
  },
  {
    ...
    meta: {
      ...
      note: "Public website event registrations and payment state",
    },
    schema: {},
    fields: [
      ID_FIELD,
      ...
      { field: "job_title", type: "string", meta: { interface: "input" } },
      {
